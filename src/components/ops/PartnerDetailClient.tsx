      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          <div className="lg:col-span-1">
            <div className="bg-white/50 backdrop-blur-xl rounded-2xl border-2 border-hti-yellow/30 p-6 h-80 animate-pulse" />
          </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 h-[calc(100vh-250px)]">
        ...
        <div className="lg:col-span-1 space-y-4">
          {/* Profile Header Card */}
          <div className="bg-gradient-to-br from-white to-hti-yellow/10 backdrop-blur-xl rounded-2xl border-2 border-hti-yellow/30 p-6 shadow-xl hover:shadow-2xl transition-shadow">
            <div className="mb-4">
            ...
            <div className="space-y-3 border-t-2 border-hti-yellow/20 pt-4">
            ...
            <div className="grid grid-cols-2 gap-2 mt-6">
              ...
              <button className="px-3 py-2 bg-white border-2 border-hti-orange text-hti-orange hover:bg-hti-orange/5 font-bold rounded-lg text-sm transition-all">
                Message
              </button>
            </div>
          </div>
          ...
          <div className="space-y-3">
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="bg-gradient-to-br from-white to-hti-orange/5 backdrop-blur-xl rounded-xl border-2 border-hti-yellow/20 p-4 shadow-lg hover:shadow-xl hover:border-hti-yellow/50 transition-all cursor-pointer group"
              >
        ...
        <div className="lg:col-span-3">
          <div className="bg-gradient-to-br from-white via-hti-yellow/3 to-hti-orange/5 backdrop-blur-xl rounded-2xl border-2 border-hti-yellow/30 shadow-xl h-full flex flex-col overflow-hidden">
            {/* Tab Navigation */}
            <div className="border-b-2 border-hti-yellow/20 flex gap-1 p-4">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-bold text-sm transition-all ${
                    activeTab === tab
                      ...
                      : "bg-white/40 text-hti-gray hover:bg-white/60 border border-hti-yellow/20"
                  }`}
                >
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {activeTab === "organization" && (
                <div className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-hti-yellow/20">
                  ...
                  {partner.notes && (
                    <div className="bg-hti-yellow/10 border-l-4 border-hti-yellow rounded-lg p-4">
              ...
              {activeTab === "details" && (
                <div className="space-y-6">
                  <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-hti-yellow/20">
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {["Adults", "Families", "Job Seekers"].map((group) => (
                            <span key={group} className="px-3 py-1 bg-hti-yellow/20 border border-hti-yellow/40 text-hti-navy rounded-full text-xs font-bold">
                              {group}
                            </span>
                          ))}
                        </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {["Digital Literacy", "Access", "Employment"].map((struggle) => (
                            <span key={struggle} className="px-3 py-1 bg-hti-orange/20 border border-hti-orange/40 text-hti-navy rounded-full text-xs font-bold">
                              {struggle}
                            </span>
                          ))}
                        </div>
