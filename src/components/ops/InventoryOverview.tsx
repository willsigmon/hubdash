      ...
      <div className="p-4 md:p-6 bg-surface-alt/60 border-b border-default">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-4">
          ...
          <div className="flex gap-2 w-full md:w-auto">
            <button className="flex-1 md:flex-none px-3 md:px-4 py-2 accent-gradient hover:shadow-lg rounded-lg text-on-accent text-xs md:text-sm font-bold transition-all hover:scale-105">
              + Add Device
            </button>
