...
export default function ApplicationSearch({
  ...
  return (
    <section className="rounded-2xl border border-default bg-gradient-to-br from-hti-orange/8 via-white to-hti-gold/5 p-4 shadow-lg backdrop-blur">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        {resultCount !== undefined && totalCount !== undefined && (
          <div className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-1.5 text-[10px] font-semibold uppercase tracking-wide text-primary shadow-sm">
      ...
      <div className="mt-4 flex items-center gap-2">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-xl border border-default bg-white/80 px-11 py-2.5 text-sm text-primary shadow-inner focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20 placeholder:text-muted"
